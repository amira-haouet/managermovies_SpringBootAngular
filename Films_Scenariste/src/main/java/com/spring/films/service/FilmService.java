...
public interface FilmService {
	...
	/*
	 * @Query("select f from Film f where f.titre = ?1") /*Page<Film>
	 * getAllFilmsParPageandbytitre(int page, int size, String titre); Page<Film>
	 * listAllbyPage(String key, int page, int size);
	 */
